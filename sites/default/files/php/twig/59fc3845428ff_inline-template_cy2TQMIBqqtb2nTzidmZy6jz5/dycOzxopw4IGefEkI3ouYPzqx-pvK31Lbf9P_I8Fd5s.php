...
class __TwigTemplate_abdb5ffac7e1a57506503cd91a4e46cb549570fd842017c73481bcb01f49f72f extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}<a href=\"#\" role=\"button\" aria-label=\"{{ styles_text }}\"><span class=\"ckeditor-button-dropdown\">{{ styles_text }}<span class=\"ckeditor-button-arrow\"></span></span></a>", "{# inline_template_start #}<a href=\"#\" role=\"button\" aria-label=\"{{ styles_text }}\"><span class=\"ckeditor-button-dropdown\">{{ styles_text }}<span class=\"ckeditor-button-arrow\"></span></span></a>", "");
    }
}
