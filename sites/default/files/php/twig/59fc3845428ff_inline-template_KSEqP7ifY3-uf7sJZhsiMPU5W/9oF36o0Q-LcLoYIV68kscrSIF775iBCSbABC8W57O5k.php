...
class __TwigTemplate_a3bcb4a76d98baecb30378c1867c0aea75d18cf970124986d8db5289253f7bbf extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}<a href=\"#\" role=\"button\" aria-label=\"{{ format_text }}\"><span class=\"ckeditor-button-dropdown\">{{ format_text }}<span class=\"ckeditor-button-arrow\"></span></span></a>", "{# inline_template_start #}<a href=\"#\" role=\"button\" aria-label=\"{{ format_text }}\"><span class=\"ckeditor-button-dropdown\">{{ format_text }}<span class=\"ckeditor-button-arrow\"></span></span></a>", "");
    }
}
